...
export class LPiece {
    ...
    rotateLPiece() {
        if (this.rotate1) {
            ...
            this.secondPart = this.firstPart[0] + String.fromCharCode(this.secondPart[1].charCodeAt(0) - 1);
            ...
            if (this.thirdPart[1] == "0") {
                ...
                this.fourthPart = String.fromCharCode(this.fourthPart[0].charCodeAt(0) + 1) + String.fromCharCode(this.fourthPart[1].charCodeAt(0) + 2);
                drawPiece();
                this.rotate2 = false;
                this.rotate3 = true;
                return;
